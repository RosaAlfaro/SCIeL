# Generated by Django 2.1.2 on 2018-11-03 23:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_actuador', models.CharField(error_messages={'empty': 'Este campo no debe quedar vacío'}, help_text='Ingrese el nombre del actuador a usar', max_length=45, null=True, verbose_name='Nombre del Actuador')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_cultivo', models.CharField(error_messages={'empty': 'Este campo no debe quedar vacío'}, help_text='Nombre de la planta a cultivar', max_length=45, null=True, verbose_name='Nombre del cultivo')),
                ('periodo_cosecha', models.IntegerField(error_messages={'value': 'Debe ser un dato entero positivo'}, help_text='Debe ingresar el tiempo que tarda el cultivo en dar frutos', null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1000)], verbose_name='Periódo de Cosecha')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_dispositivo', models.CharField(error_messages={'empty': 'Este campo no debe quedar vacío'}, help_text='Dele un nombre al dispositivo a usar en sus invernaderos', max_length=45, null=True, verbose_name='Nombre del dispositivo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_etapa', models.IntegerField(error_messages={'value': 'Debe ser un dato entero positivo'}, help_text='Debe ingresar la cantidad de etapas durante el tiempo de vida del cultivo', null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(10)], verbose_name='Número de etapa')),
                ('nombre_etapa', models.CharField(error_messages={'empty': 'Este campo no debe quedar vacío'}, help_text='Ingrese el nombre de la etapa. Ejemplo: Floración', max_length=45, null=True, verbose_name='Nombre de etapa')),
                ('duracion', models.IntegerField(error_messages={'value': 'Debe ser un dato entero positivo'}, help_text='Debe ingresar el tiempo que dura esta etapa', null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Duración de la etapa')),
                ('descripcion_etapa', models.CharField(error_messages={'empty': 'Este campo no debe quedar vacío'}, help_text='Ingrese una breve descripción de la etapa', max_length=150, null=True, verbose_name='Descripcion de la etapa')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_invernadero', models.CharField(error_messages={'empty': 'Este campo no debe quedar vacío'}, help_text='Asignele un nombre cualquiera al invernadero', max_length=45, null=True, verbose_name='Nombre del invernadero')),
                ('ubicacion', models.CharField(error_messages={'empty': 'Este campo no debe quedar vacío'}, help_text='Ingrese la ubicación del invernadero', max_length=23, null=True, verbose_name='Ubicacion del invernadero')),
                ('id_cultivo', models.ManyToManyField(blank=True, error_messages={'select': 'Debe seleccionar uno de la lista'}, help_text='Cultivo que se cosechará en este invernadero', to='invernaderos.Cultivo', verbose_name='Cultivo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('magnitud_medicion', models.DecimalField(decimal_places=2, error_messages={'value': 'Debe ser un valor positivo'}, help_text='Magnitud de la medición realizada', max_digits=5, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Magnitud de la medición')),
                ...
                ('is_activo', models.BooleanField(default=False, error_messages={'value': 'Debe ser un atributo boleano'}, help_text='Respuesta del dispositivo', null=True, verbose_name='¿Está activo?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_parametro', models.CharField(error_messages={'empty': 'Este campo no debe quedar vacío'}, help_text='Ingrese el nombre del parámetro a medir', max_length=45, null=True, verbose_name='Nombre del parámetro')),
                ('magnitud_referencia', models.DecimalField(decimal_places=2, error_messages={'value': 'Ese valor debe ser positivo'}, help_text='Ingrese el valor de la magnitud de referencia para este parámetro', max_digits=10, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Magnitud del Parámetro Base')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_sensor', models.CharField(error_messages={'empty': 'Este campo no debe quedar vacío'}, help_text='Ingrese un nombre para este sensor', max_length=45, null=True, verbose_name='Nombre del sensor')),
